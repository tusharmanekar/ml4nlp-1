...
if __name__ == '__main__':
    ...
    if csv:
        ...
        full_dataset = CBOWDataset(context_size=CONTEXT_WIDTH, word_to_ix=word_to_ix, raw_text=raw_text)
        # Split the dataset into training, validation, and test sets
        train_data, temp_data = train_test_split(full_dataset.data, test_size=0.5, random_state=42)
